...
use myGedung\Auth\Permissions\PermissibleInterface;
use myGedung\Auth\Permissions\PermissibleTrait;
use myGedung\Auth\Persistences\PersistableInterface;
use myGedung\Auth\Roles\RoleableInterface;
use myGedung\Auth\Roles\RoleInterface;
...
class EloquentUser extends Model implements RoleableInterface, PermissibleInterface, PersistableInterface, UserInterface
{
     ...
     * @var string
     */
    protected static $rolesModel = 'myGedung\Auth\Roles\EloquentRole';
     ...
     * @var string
     */
    protected static $persistencesModel = 'myGedung\Auth\Persistences\EloquentPersistence';
     ...
     * @var string
     */
    protected static $activationsModel = 'myGedung\Auth\Activations\EloquentActivation';
     ...
     * @var string
     */
    protected static $remindersModel = 'myGedung\Auth\Reminders\EloquentReminder';
     ...
     * @var string
     */
    protected static $throttlingModel = 'myGedung\Auth\Throttling\EloquentThrottle';
