...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Please provide your session key for Auth.
    |
    */

    'session' => 'mygedung_auth',
    ...
    |--------------------------------------------------------------------------
    |
    | Please provide your cookie key for Auth.
    |
    */

    'cookie' => 'mygedung_auth',
    ...
    |--------------------------------------------------------------------------
    |
    | Please provide the user model used in Auth.
    |
    */

    'users' => [

        'model' => 'myGedung\Auth\Users\EloquentUser',
    ...
    |--------------------------------------------------------------------------
    |
    | Please provide the role model used in Auth.
    |
    */

    'roles' => [

        'model' => 'myGedung\Auth\Roles\EloquentRole',
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may specify the permissions class. Auth ships with two
    | permission types.
    |
    | 'myGedung\Auth\Permissions\StandardPermissions'
    | 'myGedung\Auth\Permissions\StrictPermissions'
    |
    ...
    */
    ...
    'permissions' => [
        ...
        'class' => 'myGedung\Auth\Permissions\StandardPermissions',
    ...
    */
    ...
    'persistences' => [
        ...
        'model' => 'myGedung\Auth\Persistences\EloquentPersistence',
    ...
    */
    ...
    'activations' => [
        ...
        'model' => 'myGedung\Auth\Activations\EloquentActivation',
    ...
    */
    ...
    'reminders' => [
        ...
        'model' => 'myGedung\Auth\Reminders\EloquentReminder',
    ...
    */
    ...
    'throttling' => [
        ...
        'model' => 'myGedung\Auth\Throttling\EloquentThrottle',
