...
namespace myGedung\Auth;

use BadMethodCallException;
use myGedung\Auth\Activations\ActivationRepositoryInterface;
use myGedung\Auth\Checkpoints\CheckpointInterface;
use myGedung\Auth\Persistences\PersistenceRepositoryInterface;
use myGedung\Auth\Reminders\ReminderRepositoryInterface;
use myGedung\Auth\Roles\RoleRepositoryInterface;
use myGedung\Auth\Throttling\ThrottleRepositoryInterface;
...
class Auth
{
     ...
     *
     * @var \myGedung\Auth\Persistences\PersistenceRepositoryInterface
     */
     ...
     * The Role repository.
     *
     * @var \myGedung\Auth\Roles\RoleRepositoryInterface
     */
    protected $roles;
     ...
     *
     * @var \myGedung\Auth\Reminders\ReminderRepositoryInterface
     */
    protected $reminders;
     ...
     *
     * @var \myGedung\Auth\Throttling\ThrottleRepositoryInterface
     */
    protected $throttle;
     ...
     *
     * @param  \myGedung\Auth\Persistences\PersistenceRepositoryInterface  $persistence
     * @param  \myGedung\Auth\Users\UserRepositoryInterface  $users
     * @param  \myGedung\Auth\Roles\RoleRepositoryInterface  $roles
     ...
     * @return \myGedung\Auth\Users\UserInteface|bool
    ...
    public function activate($user)
    {
        ...
        $this->fireEvent('auth.activating', $user);

        $activations = $this->getActivationRepository();

        $activation = $activations->create($user);

        $this->fireEvent('auth.activated', [ $user, $activation ]);
    ...
    {
        return $this->bypassCheckpoints(function ($auth) {
            return $auth->check();
        });
    }
     ...
     *
     * @param  \myGedung\Auth\Users\UserInterface|array  $credentials
     * @param  bool  $remember
     * @param  bool  $login
     * @return \myGedung\Auth\Users\UserInterface|bool
     */
    ...
    {
        $response = $this->fireEvent('auth.authenticating', $credentials, true);
        ...
        $this->fireEvent('auth.authenticated', $user);
    ...
    {
        return $this->bypassCheckpoints(function ($auth) use ($credentials, $remember) {
            return $auth->authenticate($credentials, $remember);
        });
    }
    ...
    /**
     * Pass a closure to Auth to bypass checkpoints.
     *
    ...
    /**
     * Add a new checkpoint to Auth.
     *
     * @param  string  $key
     * @param  \myGedung\Auth\Checkpoints\CheckpointInterface  $checkpoint
     * @return void
     */
     ...
     *
     * @return \myGedung\Auth\Users\UserRepositoryInterface
     */
     ...
     *
     * @return \myGedung\Auth\Roles\RoleRepositoryInterface
     */
     ...
     *
     * @return \myGedung\Auth\Persistences\PersistenceRepositoryInterface
     */
     ...
     *
     * @param  \myGedung\Auth\Persistences\PersistenceRepositoryInterface  $persistences
     * @return void
     */
     ...
     *
     * @return \myGedung\Auth\Activations\ActivationRepositoryInterface
     */
     ...
     *
     * @return \myGedung\Auth\Reminders\ReminderRepositoryInterface
     */
     ...
     *
     * @param  \myGedung\Auth\Reminders\ReminderRepositoryInterface  $reminders
     * @return void
     */
     ...
     *
     * @return \myGedung\Auth\Throttling\ThrottleRepositoryInterface
     */
     ...
     *
     * @param  \myGedung\Auth\Throttling\ThrottleRepositoryInterface  $throttle
     * @return void
     */
    ...
    /**
     * Dynamically pass missing methods to Auth.
     *
     * @param  string  $method
